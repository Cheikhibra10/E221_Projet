...
public class SemestreController{
    public SemestreController(SemestreServiceImp service) {
    ...
    private final SemestreServiceImp service;
    ...
    @PostMapping
    public ResponseEntity<SemestreDtoResponse> create(@Valid @RequestBody SemestreDtoRequest dto) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<SemestreDtoResponse> update(@PathVariable Long id,@RequestBody SemestreDtoRequest dto) {
    ...
    @GetMapping
    public ResponseEntity<PageResponse<SemestreDtoResponse>> findAll(
    ...
    @GetMapping("/{id}")
    public ResponseEntity<SemestreDtoResponse> getById(@PathVariable Long id) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<SemestreDtoResponse> delete(@PathVariable Long id) {
        return ResponseEntity.ok(service.delete(id));
    }
    @Auditable(value = "#{T(this).audit('restore')}")
    @PutMapping("/{id}/restore")
    public ResponseEntity<SemestreDtoResponse> restore(@PathVariable Long id) {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<SemestreDtoResponse> patch(@PathVariable Long id, @RequestBody Map<String, Object> fields) {
