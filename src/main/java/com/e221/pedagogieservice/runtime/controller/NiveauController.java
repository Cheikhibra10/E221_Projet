...
import com.e221.pedagogieservice.runtime.services.NiveauServiceImp;
...
public class NiveauController {
    public NiveauController(NiveauServiceImp service) {
    ...
    private final NiveauServiceImp service;
    ...
    @PostMapping
    public ResponseEntity<NiveauDtoResponse> create(@Valid @RequestBody NiveauDtoRequest dto) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<NiveauDtoResponse> update(@PathVariable Long id,@RequestBody NiveauDtoRequest dto) {
    ...
    @GetMapping
    public ResponseEntity<PageResponse<NiveauDtoResponse>> findAll(
    ...
    @GetMapping("/{id}")
    public ResponseEntity<NiveauDtoResponse> getById(@PathVariable Long id) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<NiveauDtoResponse> delete(@PathVariable Long id) {
        return ResponseEntity.ok(service.delete(id));
    }
    @Auditable(value = "#{T(this).audit('restore')}")
    @PutMapping("/{id}/restore")
    public ResponseEntity<NiveauDtoResponse> restore(@PathVariable Long id) {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<NiveauDtoResponse> patch(@PathVariable Long id, @RequestBody Map<String, Object> fields) {
