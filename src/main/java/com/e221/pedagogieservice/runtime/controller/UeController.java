...
public class UeController {
    ...
    public UeController(UEServiceImp service) {
    ...
    private final UEServiceImp service;
    ...
    @PostMapping
    public ResponseEntity<UeDtoResponse> create(@Valid @RequestBody UeDtoRequest dto) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<UeDtoResponse> update(@PathVariable Long id,@RequestBody UeDtoRequest dto) {
    ...
    @GetMapping
    public ResponseEntity<PageResponse<UeDtoResponse>> findAll(
    ...
    @GetMapping("/{id}")
    public ResponseEntity<UeDtoResponse> getById(@PathVariable Long id) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<UeDtoResponse> delete(@PathVariable Long id) {
        return ResponseEntity.ok(service.delete(id));
    }
    @Auditable(value = "#{T(this).audit('restore')}")
    @PutMapping("/{id}/restore")
    public ResponseEntity<UeDtoResponse> restore(@PathVariable Long id) {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<UeDtoResponse> patch(@PathVariable Long id, @RequestBody Map<String, Object> fields) {
